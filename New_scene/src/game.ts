...
const transform5 = new Transform({
  position: new Vector3(8.5, 14, 15.5),
...
const transform8 = new Transform({
  ...
  rotation: new Quaternion(-6.433131378134633e-15, -0.6949041485786438, 8.283903696337802e-8, -0.7191024422645569),
  scale: new Vector3(2.7739856243133545, 2.84765625, 1.0005961656570435)
})
...
const transform10 = new Transform({
  position: new Vector3(15.5, 12, 1.5),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(2.082110643386841, 2.1784567832946777, 1.0005961656570435)
})
...
const transform11 = new Transform({
  ...
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.923877716064453, 5.6953125, 1.0005934238433838)
})
